    ...
    return(
        <div className="grid grid-cols-[100px,1fr] h-screen">
            ...
            <div className="flex items-center justify-center">
                <div className=" border-[1.5px] border-home_colors-Selected_Borders/text border-opacity-40 bg-home_colors-Navbar/Selection_Bg rounded-[60px] h-[550px] w-[710px] px-10 py-7">
                        ...
                        <div className="flex flex-col flex-1 w-full">
                            <div className="grid grid-cols-8 w-full h-[20px] items-end mb-2 gap-1">
                                {array.map((num) => {
                                    ...
                                    return (
                                        <div key={num} className="flex w-full h-full justify-center ">
                                        {label ? (
                                            label.length > 3 ? (
                                            <div className="relative w-full overflow-hidden">
