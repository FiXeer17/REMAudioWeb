                        ...
                        <div className="flex items-center justify-center">
                            <div className="flex flex-col w-32 h-32 border-[1px] rounded-2xl border-home_colors-Selected_Borders/text bg-home_colors-Navbar/Selection_Bg">
                                <div className="flex justify-center items-start py-[6px]">
                                    <ArrowUp color="white" size={36} weight="bold" onClick={()=>handleMovement("up")}/>
                                </div>
                                <div className="flex justify-between px-1 items-center">
                                    <ArrowLeft color="white" size={36} weight="bold" onClick={()=>handleMovement("left")}/>
                                    <ArrowsClockwise color="white" size={30} weight="bold"/>
                                    <ArrowRight color="white" size={36} weight="bold" onClick={()=>handleMovement("right")}/>
                                </div>
                                <div className="flex items-end justify-center">
                                    <ArrowDown color="white" size={36} weight="bold" onClick={()=>handleMovement("down")}/>
                                </div>
                            </div>
                        </div>
                    </div>
